...
class DioException implements Exception {
  ...
  DioException({
    ...
    this.message,
  }) : stackTrace = identical(stackTrace, StackTrace.empty) ? requestOptions.sourceStackTrace ?? StackTrace.current : stackTrace ?? requestOptions.sourceStackTrace ?? StackTrace.current;
  ...
  static String _badResponseExceptionMessage(int statusCode) {
    ...
    if (statusCode >= 100 && statusCode < 200) {
      ...
      message = 'A response with a status code that is not within the range of inclusive 100 to exclusive 600'
